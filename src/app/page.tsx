...
export default async function Home() {
  ...
  const featuredProducts = medicinesResult.data ?? [];
      ...
      <section className="relative border-b border-red-100 overflow-hidden bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
          <div className="max-w-2xl">
            ...
            <form action="/shop" className="relative max-w-md mb-6 bg-white/95 backdrop-blur-sm rounded-xl shadow-xl ring-1 ring-black/5 p-1.5">
              ...
              />
              <button type="submit" className="absolute inset-y-1.5 right-1.5 px-5 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors shadow-sm">
                Search
              </button>
            </form>
      ...
      <section className="py-16" aria-labelledby="categories-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 id="categories-heading" className="text-2xl font-bold text-gray-900 mb-2">Shop by Category</h2>
          ...
          {/* Tablist of category cards — image on top, label below.
          ...
          >
            {[
              { name: "First Aid",           image: "/images/categories/first-aid.png" },
              { name: "Wellness",             image: "/images/categories/wellness.png" },
              { name: "Mother and Baby Care", image: "/images/categories/mother-and-baby-care.png" },
              { name: "Chronic Care",         image: "/images/categories/chronic-care.png" },
              { name: "Antibiotics",          image: "/images/categories/antibiotics.png" },
              { name: "Pain Relief",          image: "/images/categories/pain-relief.png" },
            ].map((cat, idx) => {
              ...
              return (
                <Reveal key={cat.name} delay={idx * 60}>
                  <Link
                    ...
                    className="group block h-full overflow-hidden rounded-2xl border-2 border-gray-100 bg-white hover:border-red-500 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                  >
                    {/* Image */}
                    <div className="relative aspect-square overflow-hidden bg-gray-50">
                      ...
                      {/* Icon badge */}
                      <span className="absolute left-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-red-600 shadow-sm backdrop-blur-sm transition-colors group-hover:bg-red-600 group-hover:text-white">
                        <Icon size={18} />
                      </span>
                    </div>

                    {/* Category label — outside the image container */}
