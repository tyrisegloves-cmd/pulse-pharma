        ...
        <AuthProvider>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li><Link href="/upload-prescription" className="hover:text-red-600">Upload Prescription</Link></li>
                  <li><Link href="/ask" className="hover:text-red-600">Ask a Pharmacist</Link></li>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center">
              <p>&copy; {new Date().getFullYear()} Pulse Pharma. All rights reserved.</p>
              <p className="mt-2 md:mt-0 text-xs text-gray-400">Data Privacy: Health information is encrypted and strictly confidential.</p>
            </div>
          </div>
        </footer>
          </CartProvider>
